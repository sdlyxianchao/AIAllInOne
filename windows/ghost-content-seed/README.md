...
这是 AI All In One Hub 门户的示例内容快照，供新部署时一键导入，让你的门户开箱就有「平台上线公告、DeepChat/Dify 使用指南、下载中心」等示例内容。
...
| `navigation` | 主导航（Home / DeepChat / Dify） |
| `posts` | 5 条内容：1 个 DeepChat 下载页 + 4 篇示例文章（上线公告、DeepChat 使用指南、Dify 使用指南、v1.1.0 发布公告） |
