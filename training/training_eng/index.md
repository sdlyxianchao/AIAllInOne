...
| **D8** | M11 AI Admin Center (init/menus/delegated admin) | M12–M16 ops modules (Update Server/monitoring/observability/logs/MailHog) | Admin Center fully usable; alerts configured |
...
| M11 | AI Admin Center | Core | 4 | Global Admin init, menu map, delegated admin (admin:product + provisioning), availability, reports, IM alerts. Backup is now standalone scripts (`Backup/`) | [Outline](10-admin-center/outline.md) · [Textbook](10-admin-center/textbook.md) · [Plan](10-admin-center/plan.md) · [Exam](10-admin-center/exam.md) · [Refs](10-admin-center/references.md) |
