...
[← Chapter 1: Getting to Know the Platform](ch01-about.md) · [📖 Index](index.md) · [Chapter 3: Tool 1: DeepChat →](ch03-deepchat.md)
...
```mermaid
flowchart TB
    A["📰 AI All In One Hub"] --> B["📌 Home / News & announcements"]
    A --> C["⬇️ Download center"]
    A --> D["🤖 AI Workbench (jump to Dify)"]
    A --> E["📚 Help docs"]
```
