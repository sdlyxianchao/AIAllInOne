...
[← Capítulo 1: Conhecendo a plataforma](ch01-about.md) · [📖 Índice](index.md) · [Capítulo 3: Ferramenta 1: DeepChat →](ch03-deepchat.md)
...
```mermaid
flowchart TB
    A["📰 AI All In One Hub"] --> B["📌 Início / notícias e avisos"]
    A["📰 AI All In One Hub"] --> C["⬇️ Central de downloads"]
    A["📰 AI All In One Hub"] --> D["🤖 Workbench de IA (pula para o Dify)"]
    A["📰 AI All In One Hub"] --> E["📚 Documentação de ajuda"]
```
