...
> Consulte aqui primeiro quando tiver problemas.

[← Capítulo 6: Normas de segurança de dados](ch06-security.md) · [📖 Índice](index.md) · [Capítulo 8: Código de conduta →](ch08-conduct.md)
