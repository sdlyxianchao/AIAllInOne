...
```mermaid
flowchart TB
    A["📰 AI All In One Hub"] --> B["📌 Inicio / Noticias y anuncios"]
    A["📰 AI All In One Hub"] --> C["⬇️ Centro de descargas"]
    A["📰 AI All In One Hub"] --> D["🤖 Banco de trabajo de IA (saltar a Dify)"]
    A["📰 AI All In One Hub"] --> E["📚 Documentación de ayuda"]
```
