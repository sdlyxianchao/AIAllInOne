...
> Consulta aquí primero cuando tengas un problema.

[← Capítulo 6: Normativa de seguridad de datos](ch06-security.md) · [📖 Índice](index.md) · [Capítulo 8: Código de conducta →](ch08-conduct.md)
