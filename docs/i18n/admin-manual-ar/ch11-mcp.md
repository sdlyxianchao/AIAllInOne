...
> بوابة لإدارة مهارات Skill وأدوات MCP مركزيًا؛ يكفي DSH Desktop/Dify الاتصال بعنوان واحد للحصول على جميع الأدوات.

[← الفصل 10: توزيع DSH Desktop و CI/CD](ch10-dsh.md) · [📖 الفهرس](index.md) · [الفصل 12: مركز إدارة الذكاء الاصطناعي →](ch12-admin-center.md)
...
1. DSH Desktop: الإعدادات ← MCP ← إضافة خادم ← النوع «HTTP قابل للبث» والعنوان `http://<عنوان-IP-الخادم>:3100/mcp`؛
...
> 📌 في DSH Desktop يُعد MCP وSkill مفهومين مختلفين: MCP هو «أداة» (function calling)، أما Skill فهو «حزمة مهارات للوكيل الذكي» (SKILL.md + سكربتات). لا يوجد «عنوان سوق مخصص» لمهارات DSH Desktop، بل تدعم ثلاثة أنماط للتثبيت فقط: مجلد/ZIP/عنوان URL، ويتم التوزيع الداخلي عبر «التثبيت بعنوان URL» بشكل غير مباشر.
...
- **استخدم اسم مضيف وليس عنوان IP**: بيئة الوكيل في DSH Desktop تُخفي عنوان IP وتحوله إلى `[IP_ADDRESS_REDACTED]`، فلا يمكن قراءة العنوان الحقيقي؛
