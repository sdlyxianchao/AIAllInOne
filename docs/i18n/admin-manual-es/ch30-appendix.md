# Apéndice: Índice de documentación oficial

*Apéndice*

> Direcciones de la documentación oficial de todos los productos de terceros (URL en texto plano, para poder acceder incluso tras imprimir).

[← Capítulo 29: Manual de resolución de problemas](ch29-troubleshooting.md) · [📖 Índice](index.md)
