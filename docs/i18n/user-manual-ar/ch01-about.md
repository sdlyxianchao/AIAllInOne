...
```mermaid
flowchart TB
    A["📰 AI All In One Hub (البوابة)"] --> B["💬 DeepChat (محادثة سطح المكتب)<br/>ثبّته من مركز التنزيلات في البوابة"]
    A["📰 AI All In One Hub (البوابة)"] --> C["🤖 Dify (تطبيقات ويب/قاعدة معرفية)<br/>http://IP"]
```

*الشكل 1: العلاقة بين المداخل الثلاثة*

*ثلاثة مداخل: البوابة (Hub) هي نقطة البداية، وDeepChat وDify هما أداتان*
