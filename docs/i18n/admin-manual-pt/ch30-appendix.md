# Apêndice: Índice de documentação oficial

*Apêndice*

> Endereços da documentação oficial de todos os produtos de terceiros (URLs em texto simples, para consulta mesmo após impressão).

[← Capítulo 29: Manual de solução de problemas](ch29-troubleshooting.md) · [📖 Índice](index.md)
...
| Código-fonte do DSH Desktop | https://github.com/dataelement/dsh-desktop |
