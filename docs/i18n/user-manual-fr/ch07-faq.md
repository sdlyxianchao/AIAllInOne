# Chapitre 7 : FAQ - questions fréquentes

*Démarrage rapide*

> Consultez d'abord ici en cas de problème.

[← Chapitre 6 : Règles de sécurité des données](ch06-security.md) · [📖 Index](index.md) · [Chapitre 8 : Code de conduite →](ch08-conduct.md)
