...
```mermaid
flowchart TB
    A["📰 AI All In One Hub（ポータル）"] --> B["💬 DSH Desktop（デスクトップ対話）<br/>ポータルのダウンロードセンターからインストール"]
    A["📰 AI All In One Hub（ポータル）"] --> C["🤖 Dify（Web アプリ/ナレッジベース）<br/>http://IP"]
```

*図 1：3 つの入口の関係*

*3 つの入口：ポータル（Hub）が出発点、DSH Desktop と Dify が 2 つのツール*

## 1.2 プラットフォームで何ができるか

| やりたいこと | 使うツール | どこで開くか |
| --- | --- | --- |
| ChatGPT のように日常会話、文書作成、翻訳、コード修正 | 💬 DSH Desktop | デスクトップクライアント（まずポータルからダウンロード・インストール） |
...
> ✅ **一言で覚える**：**チャット/執筆/翻訳 → DSH Desktop**；**会社のアプリ/ナレッジベース → Dify**；**探し物/お知らせ閲覧/ソフトダウンロード → ポータル Hub**。3 つとも同じアカウントでログインします。
...
- **初心者**：第 2~4 章を順に読み、まず DSH Desktop をインストールして使い始めましょう；
